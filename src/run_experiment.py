...
def train_model(
    ...
    model(
        tf.random.normal(
            (1, Config.INPUT_SHAPE[0], Config.INPUT_SHAPE[1])
        )
    )
...
if __name__ == "__main__":
    ...
    DATASETS = {
        ...
        "EXP_100HZ_TO_250HZ": load_ptb_dataset(
            "E2_clean_100_to_250"
        ),

        "EXP_500HZ_TO_250HZ": load_ptb_dataset(
            "E3_clean_500_to_250"
        )
    }
